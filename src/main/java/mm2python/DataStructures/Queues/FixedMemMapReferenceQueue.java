...
//                writeBlankToMemMap(fixedMapName, bytelength);
                ...
                MappedByteBuffer buf = writeToMemMapGetBuffer(fixedMapName, bytelength);
     ...
     * @return : MappedByteBuffer
     */
    private static MappedByteBuffer writeToMemMapGetBuffer(String filename, int length) throws FileNotFoundException {
        byte[] bytearray = new byte[length];
